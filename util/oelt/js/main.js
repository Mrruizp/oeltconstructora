...
function footerFlotante() {
    ...
    var scrollTopMax = document.documentElement.scrollTopMax ||//Firefox
                       $(document).outerHeight() - $(window).outerHeight();//otros


    if (scrollTopMax == 0) {

        footer.classList.add('flotante');

    } else {

        footer.classList.remove('flotante');
    }

}


function autoActivarNivel() {

    var nivel = '',
        rbNiveles = document.querySelectorAll('input[name=rbNivel]');


    for (var n = 0, length = rbNiveles.length; n < length; n ++) {

        var rbNivel = rbNiveles[n];
        ...
        rbNivel.addEventListener('click', function (event) {
...
function mostrarNivel(nivel) {
    ...
    var lblProvincia = document.querySelector('#lblProvincia'),
        lblDistrito = document.querySelector('#lblDistrito'),
        cboProvincia = document.querySelector('#cboProvincia'),
        cboDistrito = document.querySelector('#cboDistrito');


    switch (nivel) {

        case 'regional':
            lblProvincia.classList.add('hidden');
            lblDistrito.classList.add('hidden');

            cboProvincia.classList.add('hidden');
            cboDistrito.classList.add('hidden');
            break;

        case 'local':
            lblProvincia.classList.remove('hidden');
            lblDistrito.classList.remove('hidden');

            cboProvincia.classList.remove('hidden');
            cboDistrito.classList.remove('hidden');
            break;
    }
