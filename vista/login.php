							...
							<form class="login" id="frmgrabar">
								...
								<div class="form-group">
									...
									<div class="input-group col-xs-10 col-xs-offset-1 col-sm-4">
										...
										<input id="usuario" type="text" class="form-control" placeholder="Usuario o Email..." name="usuario" maxlength="30" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="input-group col-xs-10 col-xs-offset-1 col-sm-4">
										...
										<input type="password" class="form-control" placeholder="Contraseña..." id="password" name="password" maxlength="16" required>
									</div>
								</div>

								<button class="btn primary" type="submit" id="BotonGuardar" data-loading-text="<i class='fa fa-spinner fa-pulse fa-fw'></i> Espere...">
