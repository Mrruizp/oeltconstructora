...
function listar() {
    $.post("../controller/gestionarCita.listar.controller.php").done(function(resultado) {
        ...
        if (datosJSON.estado === 200) {
            ...
            $.each(datosJSON.datos, function(i, item) {
                ...
                */
                ...
                } else html += '<td align="center" style="font-weight:normal"class="text-success"><b>' + item.estado + '</b></td>';
...
$("#frmgrabar").submit(function(event) {
    ...
    swal({
        ...
        if (isConfirm) { //el usuario hizo clic en el boton SI     
            ...
            $.post("../controller/cita.editar.controller.php", {
...
function leerDatos(codigo_paciente) {
    $.post("../controller/gestionarCita.leer.datos.controller.php", {
...
function eliminar(codCurso) {
    swal({
        ...
        if (isConfirm) {
            $.post("../controller/gestionarCurso.eliminar.controller.php", {
...
$("#frmgrabarEstado").submit(function(event) {
    ...
    swal({
        ...
        if (isConfirm) {
            $.post("../controller/gestionarEstado.editar.controller.php", {
...
function leerDatosTratamiento(codigo_cita, codigo_paciente, p_fechahisttratamiento, p_hora) {
    $.post("../controller/gestionarHistorialTratamiento.leer.datos.controller.php", {
...
$("#frmgrabarTratamientoPaciente").submit(function(event) {
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            $.post("../controller/gestionarHistorialTratamiento.agregar.editar.controller.php", {
                p_cod_tratamiento: $("#comboTratamiento").val(),
                p_cod_citaTratamiento: $("#txtCod_citaTratamiento").val(),
                p_cod_paciente: $("#txtCod_paciente").val(),
                p_fechaHistTratamiento: $("#txtFechaTratamiento").val(),
